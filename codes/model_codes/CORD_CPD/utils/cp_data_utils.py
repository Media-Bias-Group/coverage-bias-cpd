...
def load_cp_real_data(path, batch_size=1, data_norm="mean_std"):
    ...
    if data_norm == 'min_max':
        ...
        train_fea, valid_fea, test_fea = mean_std_transform(train[0], valid[0], test[0])
    #train_fea, valid_fea, test_fea = [o.transpose(0, 3, 1, 2) for o in [train_fea, valid_fea, test_fea]] leave out 
    ...
    train_cp, valid_cp, test_cp = [torch.LongTensor(o) for o in [train[1], valid[1], test[1]]] #comes from "ChangePoints" files, does not get used in training
